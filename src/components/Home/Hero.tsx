...
const Home = () => {
  return (
    <section className='body-font h-screen w-screen snap-start'>
      <div className='container mx-auto flex py-64 md:flex-row flex-col items-center'>
        ...
        <div className='lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-end md:text-left items-center text-center md:mt-0 mt-12'>
