      ...
      <div className='container mx-auto flex py-36 md:flex-row flex-col items-center'>
        <div className='lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left items-center text-center'>
          ...
          <div className='flex justify-center'>
            <button
              className='inline-flex border-0 py-2 px-12 focus:outline-none rounded-full bg-[#636C80] text-white hover:bg-[#4ED9F8]
        ...
        <div className='lg:max-w-lg lg:w-full md:w-1/2 w-5/6 flex justify-end'>
          <img className='object-cover object-center rounded' alt='hero' src={logoHero} />
        </div>
      </div>
    </section>
  )
